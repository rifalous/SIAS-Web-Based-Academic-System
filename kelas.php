    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
             ...
             <div class="col-lg-12">
                        <h2>List of Records</h2> <a href="kelas-add.php?action=add" type="button" class="btn btn-xs btn-info">Add New</a>
                ...
                $query = 'SELECT * FROM kelas';
                    $result = mysql_query($query, $db) or die (mysql_error($db));
                        ...
                        while ($row = mysql_fetch_assoc($result)) {
                            ...
                            echo '<td> <a type="button" class="btn btn-xs btn-info" href="kelas-searchfrm.php?action=edit & id='.$row['KD_KELAS'] . '" > VIEW </a> ';
                            echo ' <a  type="button" class="btn btn-xs btn-warning" href="kelas-edit.php?action=edit & id='. $row['KD_KELAS'] . '"> EDIT </a> ';
                            echo ' <a  type="button" class="btn btn-xs btn-danger" href="kelas-del.php?type=kelas&delete & id=' .$row['KD_KELAS'] . '">DELETE </a> </td>';
                            echo '</tr> ';
                }
            ?> 
