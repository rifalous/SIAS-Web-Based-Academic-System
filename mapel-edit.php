             ...
             <div class="col-lg-12">
                  <h2>Edit Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="mapel-edit1.php">
                            
                            <div class="form-group">
                              <input class="form-control" placeholder="Kode Mapel" name="KodeMapel" value="<?php echo $kodemapel; ?>">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Nama Mapel" name="NamaMapel" value="<?php echo $namamapel; ?>">
                            </div> 
