...
$query = 'SELECT * FROM guru
            ...
            $result = mysql_query($query, $db) or die(mysql_error($db));
              ...
              {   
						$a = $row['NIP'];
					    $b = $row['NAMA_GURU'];
						$c = $row['TEMPAT_LAHIR_GURU'];
						$d = $row['TANGGAL_LAHIR_GURU'];
						$e = $row['JK_GURU'];
						$f = $row['AGAMA_GURU'];
						$g = $row['ALAMAT_GURU'];
						$h = $row['TELP_GURU'];
             ...
             <div class="col-lg-12">
                  <h2>Edit Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="guru-edit1.php">
                            
							<div class="form-group">
                              <input class="form-control" placeholder="NIP" name="NIP" value="<?php echo $a; ?>">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Nama Guru" name="NamaGuru" value="<?php echo $b; ?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Tempat Lahir" name="TempatLahir" value="<?php echo $c; ?>">
                            </div> 
                            <div class="form-group">
                              <input type="date" class="form-control" placeholder="Tanggal Lahir" name="TanggalLahir" value="<?php echo $d; ?>">
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                             <label>Alamat</label>
                              <input class="form-control" placeholder="Alamat" name="Alamat" value="<?php echo $g; ?>">
                            </div>  
                            <div class="form-group">
                              <input class="form-control" placeholder="No Telp" name="NoTelp" value="<?php echo $h; ?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Jabatan" name="Jabatan" value="<?php echo $i; ?>">
                            </div>  
                            <div class="form-group">
                              <input class="form-control" placeholder="Kode Mapel" name="KodeMapel" value="<?php echo $j; ?>">
                            </div>
