             ...
             <div class="col-lg-12">
                  <h2>Add new Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="jadwal-transac.php?action=add">
                            
							<div class="form-group">
                              <input class="form-control" placeholder="ID Jadwal" name="IDJadwal">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Jurusan" name="Jurusan">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Waktu" name="Waktu">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Hari" name="Hari">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="NIP" name="NIP">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Kode Mapel" name="KodeMapel">
                            </div> 
