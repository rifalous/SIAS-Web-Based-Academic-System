  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			  ...
			  <li class="active"><a href="matapelajaran.php"><i class="fa fa-book"></i><span>Mata Pelajaran</span></a></li>
			        <li><a href="kelas.php"><i class="fa fa-university"></i><span>Kelas</span></a></li>
			        <li><a href="jurusan.php"><i class="fa fa-graduation-cap"></i><span>Jurusan</span></a></li>
      ...
      <div class="content-wrapper">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="matapelajaran_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<div class="form-group">
								<label>Kode Mata Pelajaran</label>
									<div class="input-group">
										...
										<input name="Kode_Matapelajaran" type="text" class="form-control" placeholder="Kode Mata Pelajaran"/>
									</div>
							</div>
							<div class="form-group">
								<label>Mata Pelajaran</label>
									<div class="input-group">
										...
										<input name="Nama_Matapelajaran" type="text" class="form-control" placeholder="Mata Pelajaran"/>
									</div>
							</div>
		...
		<div id="ModalEditMataPelajaran" class="modal fade" tabindex="-1" role="dialog"></div>
