        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              <li class="header"><h4><b><center>Menu Panel</center></b></h4></li>
					...
					<li><a href="matapelajaran.php"><i class="fa fa-book"></i><span>Mata Pelajaran</span></a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<h1><center><b>Sarana Informasi Akademik Sekolah</b></center></h1>
					<center><img src="../aset/foto/sias.png" width="225" height="225" /></center>
					<center><h2><b>Arcana Team Copyright &copy;  <?php echo date ('Y') ?></b></h2></center>
					<center><h4><b>Made with <strong><i class="fa fa-code"></i></strong> and <i class="fa fa-heart"></i> by Arcana Team in Bandung, West Java Indonesia</b></h4></center>
                </div><!-- /.box-header -->
                <div class="box-body">
