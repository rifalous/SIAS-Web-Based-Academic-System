             ...
             <div class="col-lg-12">
                  <h2>Edit Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="jadwal-edit1.php">
                            
							<div class="form-group">
                              <input class="form-control" placeholder="ID Jadwal" name="IDJadwal" value="<?php echo $a; ?>">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Jurusan" name="Jurusan" value="<?php echo $b; ?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Waktu" name="Waktu" value="<?php echo $c ?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Hari" name="Hari" value="<?php echo $d; ?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="NIP" name="NIP" value="<?php echo $e; ?>">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Kode Mapel" name="KodeMapel" value="<?php echo $f; ?>">
                            </div>
