             ...
             <div class="col-lg-12">
                  <h2>Edit Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="kelas-edit1.php">
                            
                            <div class="form-group">
                              <input class="form-control" placeholder="Kode Kelas" name="KodeKelas" value="<?php echo $kodekelas; ?>">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Nama Kelas" name="NamaKelas" value="<?php echo $namakelas; ?>">
                            </div> 
