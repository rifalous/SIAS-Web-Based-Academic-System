    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
             ...
             <div class="col-lg-12">
                        <h2>List of Records</h2> <a href="mapel-add.php?action=add" type="button" class="btn btn-xs btn-info">Add New</a>
                ...
                $query = 'SELECT * FROM mapel';
                    $result = mysql_query($query, $db) or die (mysql_error($db));
                        ...
                        while ($row = mysql_fetch_assoc($result)) {
                            ...
                            echo '<td> <a type="button" class="btn btn-xs btn-info" href="mapel-searchfrm.php?action=edit & id='.$row['KD_MAPEL'] . '" > VIEW </a> ';
                            echo ' <a  type="button" class="btn btn-xs btn-warning" href="mapel-edit.php?action=edit & id='.$row['KD_MAPEL'] . '"> EDIT </a> ';
                            echo ' <a  type="button" class="btn btn-xs btn-danger" href="mapel-del.php?type=mapel&delete & id=' . $row['KD_MAPEL'] . '">DELETE </a> </td>';
                            echo '</tr> ';
                }
            ?> 
