                        ...
                        <form role="form" method="post" action="edit1.php">
                            ...
                            <div class="form-group">
                             <label>Alamat Siswa</label>
                              <textarea class="form-control" rows="3"  name="AlamatSiswa" value="<?php echo $h; ?>"></textarea>
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                             <label>Alamat Ortu</label>
                              <textarea class="form-control" rows="3"  name="AlamatOrtu" value="<?php echo $o; ?>"></textarea>
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                             <label>Alamat Wali</label>
                              <textarea class="form-control" rows="3"  name="AlamatWali" value="<?php echo $r; ?>"></textarea>
                            </div> 
                            <div class="form-group">
