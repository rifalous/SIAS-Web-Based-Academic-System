    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
             ...
             <div class="col-lg-12">
                        <h2>List of Records</h2> <a href="nilai-add.php?action=add" type="button" class="btn btn-xs btn-info">Add New</a>
                ...
                $query = 'SELECT * FROM nilai';
                    $result = mysql_query($query, $db) or die (mysql_error($db));
                        ...
                        while ($row = mysql_fetch_assoc($result)) {
                            ...
                            echo '<tr>';
                            echo '<td>'. $row['NILAI_ANGKA'].'</td>';
                            echo '<td>'. $row['NIS'].'</td>';
                            echo '<td>'. $row['KD_MAPEL'].'</td>';
                            echo '<td> <a type="button" class="btn btn-xs btn-info" href="nilai-searchfrm.php?action=edit & id='.$row['ID'] . '" > VIEW </a> ';
                            echo ' <a  type="button" class="btn btn-xs btn-warning" href="nilai-edit.php?action=edit & id='.$row['ID'] . '"> EDIT </a> ';
                            echo ' <a  type="button" class="btn btn-xs btn-danger" href="nilai-del.php?type=nilai&delete & id=' . $row['ID'] . '">DELETE </a> </td>';
                            echo '</tr> ';
                }
            ?> 
