             ...
             <div class="col-lg-12">
                  <h2>Add new Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="kelas-transac.php?action=add">
                            
                            <div class="form-group">
                              <input class="form-control" placeholder="Kode Kelas" name="KodeKelas">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Nama Kelas" name="NamaKelas">
                            </div> 
